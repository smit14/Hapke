...
def residual(params):
    ...
    b = params['b'].value
    c = params['c'].value
    w = [params['w1'].value,params['w2'].value,params['w3'].value,params['w4'].value,params['w5'].value,params['w6'].value]
    for i in range(15):
...
for lamda_index in range(461):
    ...
    w[lamda_index,:] = [out.params['w1'].value,out.params['w2'].value,out.params['w3'].value,out.params['w4'].value,out.params['w5'].value,out.params['w6'].value]
